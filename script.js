    ...
    let timerId = setInterval(function() {
        ...
        if (currentPlayer === 1) {
            if (playing) {
                ...
                p1time.minutes = parseInt(p1time.getMinutes('#min1'), 00);
                if(p1sec === 59) {
        ...
        // Player 2
            ...
            p1sec = 0;
            if (playing) {
                p2time.minutes = parseInt(p2time.getMinutes('#min2'), 00);
                if(p2sec === 59) {
        ...
        // Player 3
            ...
            if (playing) {
                p3time.minutes = parseInt(p3time.getMinutes('#min3'), 00);
                if(p3sec === 59) {
        ...
        // Player 4
            ...
            if (playing) {
                p4time.minutes = parseInt(p4time.getMinutes('#min4'), 00);
                if(p4sec === 59) {
